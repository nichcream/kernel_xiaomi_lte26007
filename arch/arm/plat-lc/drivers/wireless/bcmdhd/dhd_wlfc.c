...
int dhd_wlfc_enable(dhd_pub_t *dhd)
{
	...
	dhd->wlfc_state = dhd->wlfc_state_pre;
...
dhd_wlfc_init(dhd_pub_t *dhd)
{
	...
	*/
	...
	dhd->wlfc_state_pre = vmalloc(sizeof(athost_wl_status_info_t));
	if (dhd->wlfc_state_pre == NULL) {
		DHD_ERROR(("vmalloc mem failed\n"));
	}
	return BCME_OK;
}
...
dhd_wlfc_deinit(dhd_pub_t *dhd)
{
	...
	vfree(dhd->wlfc_state_pre);
	dhd->wlfc_state_pre = NULL;
