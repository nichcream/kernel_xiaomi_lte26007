...
static struct v4l2_isp_parm ov13850_isp_parm = {
	.min_exposure = 0x01,
...
static struct isp_regb_vals isp_aecgc_win_8M_matrix[] = {
	...
	{0x6640a, 0x88},//nWin_Left
	{0x6640d, 0x01},
	{0x6640e, 0xf0},//nWin_Top
	{0x66411, 0x07},
	{0x66412, 0xb0},//nWin_Width
	{0x66415, 0x05},
	{0x66416, 0xb0},//nWin_Height
...
static struct isp_regb_vals isp_aecgc_win_13M_matrix[] = {
	{0x66409, 0x03},//definiton of the center 3x3 window
	{0x6640a, 0x20},//nWin_Left
	{0x6640d, 0x02},
	{0x6640e, 0x58},//nWin_Top
	{0x66411, 0x0a},
	{0x66412, 0x40},//nWin_Width
	{0x66415, 0x07},
	{0x66416, 0x90},//nWin_Height
...
static struct isp_regb_vals isp_aecgc_win_13M_center[] = {
	{0x66409, 0x03},//definiton of the center 3x3 window
	{0x6640a, 0x20},//nWin_Left
	{0x6640d, 0x02},
	{0x6640e, 0x58},//nWin_Top
...
static struct isp_regb_vals isp_aecgc_win_13M_central_weight[] = {
	{0x66409, 0x03},//definiton of the center 3x3 window
	{0x6640a, 0x20},//nWin_Left
	{0x6640d, 0x02},
	{0x6640e, 0x58},//nWin_Top
...
static const struct v4l2_isp_regval ov13850_isp_setting[] = {
	// add for hdr
	{0x1c470, 0x01},
	{0x1c471, 0x00},
	// add end
	...
	{0x1c13f, 0x02},
	{0x1c164, 0x00},//60Hz banding step
	{0x1c165, 0x50},
	{0x1c166, 0x00},//50Hz banding step
	{0x1c167, 0x60},
	{0x1c176, 0x06},//VTS
	{0x1c177, 0x80},
	{0x1c150, 0x00},//max gain
	...
	// for zte/leadcore ov13850 project
...
static const struct v4l2_isp_regval ov13850_isp_setting[] = {
	...
	{0x63c0a, 0x01},
	{0x63c0b, 0x53},
	{0x63c0c, 0x04},//control IDI FIFO write speed

	/* L1813 performance setting */
	/* 0v13850, 1280x960 preview */
...
/* aecagc */
	...
	/* dynamic frame rate */
	{0x1c13a, 0x01},// turn off dynamic framerate
	...
	{0x1c140, 0x01},//banding
	{0x1c13f, 0x02},
	{0x1c180, 0x1a},//60Hz banding step
	{0x1c181, 0x00},
	{0x1c182, 0x1f},//50Hz banding step
	{0x1c183, 0x33},
	{0x1c176, 0x06},//VTS
	{0x1c177, 0x80},
	{0x1c150, 0x00},//max gain
	...
	{0x66401, 0x00},
	{0x66402, 0x4e},//StatWin_Left
	{0x66403, 0x00},
	{0x66404, 0x44},//StatWin_Top
	{0x66405, 0x00},
	{0x66406, 0x4c},//StatWin_Right
	{0x66407, 0x00},
	{0x66408, 0x4c},//StatWin_Bottom
	{0x66409, 0x01},//definiton ofthe center 3x3 window
	{0x6640a, 0x46},//nWin_Left = 200
	{0x6640d, 0x00},
	{0x6640e, 0xee},//nWin_Top = 150
	{0x66411, 0x05},
	{0x66412, 0x9c},//nWin_Width = 880
	{0x66415, 0x04},
	{0x66416, 0x12},//nWin_Height = 660
	{0x6642e, 0x01},//nWin_Weight_0 weight pass
	{0x6642f, 0x01},//nWin_Weight_1
	{0x66430, 0x01},//nWin_Weight_2
	{0x66431, 0x01},//nWin_Weight_3
