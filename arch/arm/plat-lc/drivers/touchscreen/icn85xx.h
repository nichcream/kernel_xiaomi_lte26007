...
//-----------------------------------------------------------------------------
     ...
     #define CTP_IRQ_PORT             ICN85XX_INT_PIN
     #define CTP_IRQ_MODE             0
     #define CTP_RST_PORT             ICN85XX_RST_PIN
     ...
     #define COMPILE_FW_WITH_DRIVER     1//zhangchg 
     #define FORCE_UPDATA_FW             0
     #define SUSPEND_POWER_OFF           0 
     #define SUPPORT_SENSOR_ID           0  
     #define SUPPORT_DELAYED_WORK        1
     #define SUPPORT_ESD_CHECK               1//  CONFIG_BEAT_TIMER
     
     #define ICN85XX_NAME                "icn85xx-ts"//"chipone-ts"
...
struct icn85xx_ts_data {
  ...
  #ifdef SUPPORT_ESD_CHECK
   struct hrtimer             esd_timer;
   struct delayed_work      esd_monitor_work;
   struct workqueue_struct   *esd_monitor_workqueue;
  #endif
