...
#define AP_TX_TRAFFIC_BUSY_THRESHOLD 10
...
#define RX_TRAFFIC_BUSY_THRESHOLD 2
#else
...
enum LPS_CTRL_TYPE
{
	...
	LPS_CTRL_BT_WIFI_MEDIA_STATUS_NOTIFY =7,
};
...
extern u8 rtw_disassoc_cmd(_adapter  *padapter,bool enqueue);
