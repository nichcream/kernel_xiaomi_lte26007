#ifndef __ASM_ARCH_BOARD_FOURMODE_H__
#define __ASM_ARCH_BOARD_FOURMODE_H__

#include <plat/mfp.h>
#include <plat/comipfb.h>

#if defined(CONFIG_COMIP_PROJECT_FOURMODE)
#if defined(CONFIG_COMIP_BOARD_FOURMODE_V1_0)
