...
#ifdef CONFIG_WFDS
#define	P2P_ATTR_SERVICE_HASH			21
#define	P2P_ATTR_SESSION_INFO			22
#define	P2P_ATTR_CONNECT_CAPABILITY		23
#define	P2P_ATTR_ADV_ID					24
#define	P2P_ATTR_ADV_SERVICE_INFO		25
#define	P2P_ATTR_SESSION_ID				26
#define	P2P_ATTR_FEATURE_CAPABILITY		27
#define	P2P_ATTR_PERSIST_GROUP_INFO		28
#define	P2P_ATTR_SESSION_INFO_RSP		29
#endif
