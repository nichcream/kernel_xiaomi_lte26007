...
#elif defined(CONFIG_COMIP_BOARD_LC1860_EVB3) || defined(CONFIG_COMIP_BOARD_LC1860_ZEUS)
...
#endif
#if defined(CONFIG_COMIP_BOARD_LC1860_EVB2) || defined(CONFIG_COMIP_BOARD_LC1860_EVB3) || defined(CONFIG_COMIP_BOARD_LC1860_ZEUS)
...
static struct pmic_power_module_map lc1160_power_module_map[] = {
...
#if 1//defined(CONFIG_MMC_COMIP_IOPOWER)
	...
	{PMIC_ALDO7,	PMIC_POWER_CAMERA_ANALOG,		0,	1},
	{PMIC_ALDO8,	PMIC_POWER_CAMERA_ANALOG,		1,	1},
...
static struct pmic_power_ctrl_map lc1160_power_ctrl_map[] = {
...
#if defined(CONFIG_COMIP_BOARD_LC1860_EVB3) || defined(CONFIG_COMIP_BOARD_LC1860_ZEUS)
	...
	{PMIC_ALDO8,	PMIC_POWER_CTRL_REG,	PMIC_POWER_CTRL_GPIO_ID_NONE,	3300},
                                ...
                                struct kobj_attribute *attr, char *buf)
{
	...
	return sprintf(buf,
	               ...
	               "\n");
#elif defined(CONFIG_COMIP_BOARD_LC1860_EVB2) || defined (CONFIG_COMIP_BOARD_LC1860_EVB3) || defined(CONFIG_COMIP_BOARD_FOURMODE_V1_0)
	/**720p**/
	return sprintf(buf,
...
static struct ft5x06_info comip_i2c_ft5x06_info = {
	...
	.power_i2c_flag = 1,
	.power_ic_flag = 1,
#if defined(CONFIG_COMIP_BOARD_LC1860_EVB) || defined (CONFIG_COMIP_BOARD_LC1860_ZEUS)
	.max_scrx = 480,
	.max_scry = 800,
#elif defined(CONFIG_COMIP_BOARD_LC1860_EVB2) || defined(CONFIG_COMIP_BOARD_LC1860_EVB3) || defined(CONFIG_COMIP_BOARD_FOURMODE_V1_0)
	.max_scrx = 720,
...
#elif defined(CONFIG_LCD_TRULY_H8394A) || defined(CONFIG_LCD_FL10802) 
static int comip_lcd_power(int onoff)
{
...
#elif defined(CONFIG_COMIP_BOARD_LC1860_EVB3) || defined(CONFIG_COMIP_BOARD_FOURMODE_V1_0)
	printk(" ov13850 power : %d\n", onoff);
