	...
	)
{
	...
	if(pPktinfo->StationID >= ODM_ASSOCIATE_ENTRY_NUM) {
		DBG_871X("%s: Invalid StationID: %d/%d\n", __FUNCTION__, pPktinfo->StationID, ODM_ASSOCIATE_ENTRY_NUM);
		return;
	}
    ...
    )
{
	...
	if (pDM_Odm->SupportICType == ODM_RTL8723A)
	{
		...
		ODM_RT_TRACE(pDM_Odm, ODM_COMP_INIT, ODM_DBG_LOUD, ("ODM_ConfigRFWithHeaderFile() Radio_A:Array_RadioA_1T_8723A\n"));
	...
	{
		if(eRFPath == ODM_RF_PATH_A)
			READ_AND_CONFIG_MP(8723B,_RadioA_1T_);

		ODM_RT_TRACE(pDM_Odm, ODM_COMP_INIT, ODM_DBG_LOUD, ("ODM_ConfigRFWithHeaderFile() Radio_A: Array_RadioA_1T_8723B\n"));
		ODM_RT_TRACE(pDM_Odm, ODM_COMP_INIT, ODM_DBG_TRACE, ("ODM_ConfigRFWithHeaderFile: Radio No %x\n", eRFPath));
	}
#endif
#if (RTL8188E_SUPPORT == 1)
    ...
    )
{
	...
	{
		if (pDM_Odm->SupportInterface == ODM_ITRF_PCIE)
			READ_AND_CONFIG(8723B,_TxPowerTrack_PCIE_);
		else if (pDM_Odm->SupportInterface == ODM_ITRF_USB)
			READ_AND_CONFIG(8723B,_TxPowerTrack_USB_);
	...
	)
{
    ...
    if(pDM_Odm->SupportICType == ODM_RTL8723A)
	{
		...
		ODM_RT_TRACE(pDM_Odm,ODM_COMP_INIT, ODM_DBG_LOUD, ("ODM_ConfigBBWithHeaderFile() phy:Array_AGC_TAB_1T_8723A\n"));
		ODM_RT_TRACE(pDM_Odm,ODM_COMP_INIT, ODM_DBG_LOUD, ("ODM_ConfigBBWithHeaderFile() agc:Array_PHY_REG_1T_8723A\n"));
	}
#endif
#if (RTL8723B_SUPPORT == 1)
    if(pDM_Odm->SupportICType == ODM_RTL8723B)
	{
		...
		if(ConfigType == CONFIG_BB_PHY_REG)
		{
			READ_AND_CONFIG_MP(8723B,_PHY_REG_1T_);
		}
		else if(ConfigType == CONFIG_BB_AGC_TAB)
		{
			READ_AND_CONFIG_MP(8723B,_AGC_TAB_1T_);
		}
		ODM_RT_TRACE(pDM_Odm,ODM_COMP_INIT, ODM_DBG_LOUD, ("ODM_ConfigBBWithHeaderFile() phy:Array_AGC_TAB_1T_8723B\n"));
		ODM_RT_TRACE(pDM_Odm,ODM_COMP_INIT, ODM_DBG_LOUD, ("ODM_ConfigBBWithHeaderFile() agc:Array_PHY_REG_1T_8723B\n"));
	}
#endif
...
//		}
		...
		else if(ConfigType == CONFIG_BB_PHY_REG_PG)
		{
			...
			ODM_RT_TRACE(pDM_Odm,ODM_COMP_INIT, ODM_DBG_LOUD, ("ODM_ConfigBBWithHeaderFile() agc:Rtl8188EPHY_REG_PGArray\n"));
		}
	}
#endif
	...
	)
{
	...
	if (pDM_Odm->SupportICType == ODM_RTL8723A)
	{
		...
		ODM_RT_TRACE(pDM_Odm,ODM_COMP_INIT, ODM_DBG_LOUD, ("ODM_ConfigMACWithHeaderFile() phy:Array_MAC_REG_8723A\n"));
	}
#endif
#if (RTL8723B_SUPPORT == 1)
	if (pDM_Odm->SupportICType == ODM_RTL8723B)
	{
		READ_AND_CONFIG_MP(8723B,_MAC_REG_);
		ODM_RT_TRACE(pDM_Odm,ODM_COMP_INIT, ODM_DBG_LOUD, ("ODM_ConfigMACWithHeaderFile() phy:Array_MAC_REG_8723B\n"));
	}
#endif
#if (RTL8188E_SUPPORT == 1)
	if (pDM_Odm->SupportICType == ODM_RTL8188E)
