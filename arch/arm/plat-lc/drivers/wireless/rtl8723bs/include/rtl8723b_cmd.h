...
// _GPIO_CTRL_CMD_0x13
#define SET_8723B_H2CCMD_GPIOCTRL_PARM_GPIOIDX(__pH2CCmd, __Value)	SET_BITS_TO_LE_1BYTE((__pH2CCmd)+0, 0, 4, __Value)
#define SET_8723B_H2CCMD_GPIOCTRL_PARM_C2HEN(__pH2CCmd, __Value)	SET_BITS_TO_LE_1BYTE((__pH2CCmd)+0, 4, 1, __Value)
#define SET_8723B_H2CCMD_GPIOCTRL_PARM_PULSE(__pH2CCmd, __Value)	SET_BITS_TO_LE_1BYTE((__pH2CCmd)+0, 5, 1, __Value)
#define SET_8723B_H2CCMD_GPIOCTRL_PARM_HIGH_ACTIVE(__pH2CCmd, __Value)	SET_BITS_TO_LE_1BYTE((__pH2CCmd)+0, 6, 1, __Value)
#define SET_8723B_H2CCMD_GPIOCTRL_PARM_EN(__pH2CCmd, __Value)		SET_BITS_TO_LE_1BYTE((__pH2CCmd)+0, 7, 1, __Value)
#define SET_8723B_H2CCMD_GPIOCTRL_PARM_DUR(__pH2CCmd, __Value)		SET_BITS_TO_LE_1BYTE((__pH2CCmd)+1, 0, 8, __Value)
#define SET_8723B_H2CCMD_GPIOCTRL_PARM_C2HDUR(__pH2CCmd, __Value)	SET_BITS_TO_LE_1BYTE((__pH2CCmd)+2, 0, 8, __Value)
...
#define SET_8723B_H2CCMD_REMOTE_WAKE_CTRL_SCAN_OFFLOAD_EN(__pH2CCmd, __Value)				SET_BITS_TO_LE_1BYTE(__pH2CCmd, 4, 1, __Value)
#define SET_8723B_H2CCMD_REMOTE_WAKE_CTRL_REAL_WOWLAN_EN(__pH2CCmd, __Value)				SET_BITS_TO_LE_1BYTE(__pH2CCmd, 5, 1, __Value)
#define SET_8723B_H2CCMD_REMOTE_WAKE_CTRL_REAL_WOWLAN_V2_EN(__pH2CCmd, __Value)				SET_BITS_TO_LE_1BYTE(__pH2CCmd, 6, 1, __Value)
#define SET_8723B_H2CCMD_REMOTE_WAKE_CTRL_MATCH_QQ_EN(__pH2CCmd, __Value)				SET_BITS_TO_LE_1BYTE(__pH2CCmd, 7, 1, __Value)
