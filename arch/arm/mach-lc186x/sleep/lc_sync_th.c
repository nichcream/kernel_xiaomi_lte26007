/*
  * arch/arm/mach-lc186x/sleep/lc_sync_th.c
  *
  * Copyright (c) 2015 leadcore Technologies CO., Ltd.
  *
...
EXPORT_SYMBOL(lc_sys_sync_queue);
...
EXPORT_SYMBOL(lc_sys_sync_wait);
