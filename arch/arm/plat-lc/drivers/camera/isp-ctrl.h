...
extern int isp_set_saturation_hdr(struct isp_device *isp, int val);
...
extern int isp_set_dynamic_framerate_enable(struct isp_device *isp, int enable);
extern int isp_set_ct_saturation(struct isp_device *isp, int val);
extern int isp_set_lens_threshold(struct isp_device *isp);
extern int isp_set_win_setting(struct isp_device *isp, int width, int height);
extern int isp_trigger_caf(struct isp_device *isp);
