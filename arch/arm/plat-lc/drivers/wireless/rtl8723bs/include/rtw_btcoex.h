...
#define	BT_IQKNotify(padapter, state)
...
#define BT_SwitchGntBt(Adapter)
#define	BT_PnpNotify(Adapter, pnpState)
#define	BT_DownloadFwNotify(Adapter, Begain)
...
//=======================================
#define	BT_IsP2pGoConnected					FALSE
#define	BT_IsP2pClientConnected					FALSE
...
#define	BT_IsBtLpsOn(Adapter)							FALSE
#define	BT_IsLowPwrDisable(Adapter)						FALSE
#define	BT_ForceExecPwrCmd(Adapter)						FALSE
#define	BT_IsBtDisabled(Adapter)							FALSE
#define	BT_1Ant(Adapter)									FALSE
#define	BT_CoexLpsVal(Adapter)					0
#define	BT_CoexRpwmVal(Adapter)					0
...
#define BT_IncreaseScanDeviceNum(Adapter)				FALSE
