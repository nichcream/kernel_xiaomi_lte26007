...
static struct regval_list ov5648_init_regs[] = {
	...
	//{0x3035, 0x21}, // PLL
	//{0x3036, 0x69}, // PLL
	//{0x3037, 0x03}, // PLL origin set

	//{0x3035, 0x11}, // PLL sysclk 84.5M
	//{0x3036, 0x41}, // PLL
	//{0x3037, 0x03}, // PLL neil set
			  ...
			  struct v4l2_mbus_framefmt *fmt)
{
	...
	if (((info->win != wsize)
		...
		data->vts = wsize->vts;
		data->mipi_clk = 422; //282; //TBD/* Mbps. */
