...
typedef enum kbase_uk_pmm_perf_level {
    KBASE_PMM_GPU_NO_CONTROL = 0,
    KBASE_PMM_GPU_LOW_PERFORMANCE_LEVEL = 1,
    KBASE_PMM_GPU_STANDARD_LEVEL,
    KBASE_PMM_GPU_HIGH_PERFORMANCE_LEVEL
} kbase_uk_pmm_perf_level;

typedef struct {
    uk_header header;
    u32  dvfs_enable;
    kbase_uk_pmm_perf_level perf_level;
    u32  max_freq;
    u32  min_freq;
} kbase_uk_pmm_dvfs_set_s;
...
typedef struct {
	...
	u32  upthreshold;
	u32  downthreshold;
} kbase_uk_pmm_config_set_s;

typedef struct {
	uk_header header;
	u32  debug_level;
} kbase_uk_pmm_dvfs_debuglevel_set_s;

typedef struct {
	uk_header header;
	u32  clk_freq;
} kbase_uk_pmm_setclk_freq_s;
...
typedef enum kbase_uk_function_id {
	...
	KBASE_FUNC_PMM_DVFS_SET,
	KBASE_FUNC_PMM_DVFS_GET,
	KBASE_FUNC_PMM_CONFIG_GET,
	KBASE_FUNC_PMM_CONFIG_SET,
	KBASE_FUNC_PMM_DVFS_DEBUGLEVEL_SET,
	KBASE_FUNC_PMM_SETCLK_FREQ,
	KBASE_FUNC_PMM_GETCLK_FREQ,
