 ...
 *
 *  $Id: 8192e_sdio_xmit.h,v 1.4.4.5 2010/12/10 06:11:55 family Exp $
 *
...
#define MAX_XMITBUF_SZ		(15360) // 15k 1536*10
...
#else
#define MAX_BCN_XMITBUF_SZ      (5116)     //zyj test 20141222 modify beacon buffer size 4096->5116
