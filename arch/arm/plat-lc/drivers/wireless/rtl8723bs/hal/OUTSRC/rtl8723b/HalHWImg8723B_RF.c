...
void
ODM_ReadAndConfig_RadioA_1T_8723B(
 	...
 	)
{
	...
	u4Byte     ArrayLen    = sizeof(Array_RadioA_1T_8723B)/sizeof(u4Byte);
	pu4Byte    Array       = Array_RadioA_1T_8723B;
	...
	hex += platform << 16;
	hex += 0xFF000000;
	ODM_RT_TRACE(pDM_Odm, ODM_COMP_INIT, ODM_DBG_TRACE, ("===> ODM_ReadAndConfig_RadioA_1T_8723B, hex = 0x%X\n", hex));
...
void
ODM_ReadAndConfig_TxPowerTrack_AP_8723B(
 	IN   PDM_ODM_T  pDM_Odm
 	)
{
	PODM_RF_CAL_T  pRFCalibrateInfo = &(pDM_Odm->RFCalibrateInfo);

	ODM_RT_TRACE(pDM_Odm, ODM_COMP_INIT, ODM_DBG_TRACE, ("===> ODM_ReadAndConfig_TxPowerTrack_AP_8723B\n"));
...
void
ODM_ReadAndConfig_TxPowerTrack_PCIE_8723B(
 	IN   PDM_ODM_T  pDM_Odm
 	)
{
	PODM_RF_CAL_T  pRFCalibrateInfo = &(pDM_Odm->RFCalibrateInfo);

	ODM_RT_TRACE(pDM_Odm, ODM_COMP_INIT, ODM_DBG_TRACE, ("===> ODM_ReadAndConfig_TxPowerTrack_PCIE_8723B\n"));
...
void
ODM_ReadAndConfig_TxPowerTrack_USB_8723B(
 	IN   PDM_ODM_T  pDM_Odm
 	)
{
	PODM_RF_CAL_T  pRFCalibrateInfo = &(pDM_Odm->RFCalibrateInfo);

	ODM_RT_TRACE(pDM_Odm, ODM_COMP_INIT, ODM_DBG_TRACE, ("===> ODM_ReadAndConfig_TxPowerTrack_USB_8723B\n"));
