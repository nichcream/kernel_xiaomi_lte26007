...
int cw1200_load_firmware(struct cw1200_common *priv)
{
	...
	if (major_revision == 1) {
		...
		if (ar1 == CW1200_CUT_22_ID_STR1 &&
			...
			cw1200_dbg(CW1200_DBG_MSG, "Cut1200 2.2 detected.\n");
			priv->hw_revision = CW1200_HW_REV_CUT22;
		} else if ( ar1 == CW1250_CUT_11_ID_STR1 &&
			    ar2 == CW1250_CUT_11_ID_STR2 &&
			    ar3 == CW1250_CUT_11_ID_STR3) {
			cw1200_dbg(CW1200_DBG_MSG, "C1250 cut1.1 detected.\n");
			priv->hw_revision = CW1250_HW_REV_CUT11;
		} else {
			cw1200_dbg(CW1200_DBG_MSG, "Cut1200 2.0 detected.\n");
