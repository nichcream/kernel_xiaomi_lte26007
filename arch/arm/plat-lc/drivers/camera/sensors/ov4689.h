...
static struct isp_regb_vals isp_aecgc_win_1M_matrix[] = {
	{0x66409, 0x01},//definiton ofthe center 3x3 window
	{0x6640a, 0x40},//nWin_Left = 368
	{0x6640d, 0x01},
	{0x6640e, 0xE0},//nWin_Top = 276
	{0x66411, 0x02},
	{0x66412, 0x80},//nWin_Width = 736
	{0x66415, 0x00},
	{0x66416, 0xf0},//nWin_Height = 552
...
static struct isp_regb_vals isp_aecgc_win_1M_center[] = {
	{0x66409, 0x01},//definiton ofthe center 3x3 window
	{0x6640a, 0x40},//nWin_Left = 368
	{0x6640d, 0x01},
	{0x6640e, 0xE0},//nWin_Top = 276
...
static struct isp_regb_vals isp_aecgc_win_1M_central_weight[] = {
	{0x66409, 0x01},//definiton ofthe center 3x3 window
	{0x6640a, 0x40},//nWin_Left = 368
	{0x6640d, 0x01},
	{0x6640e, 0xE0},//nWin_Top = 276
...
static struct isp_regb_vals isp_aecgc_win_5M_matrix[] = {
#if 0
		{0x66409, 0x02},//definiton ofthe center 3x3 window
		{0x6640a, 0x80},//nWin_Left = 368
		{0x6640d, 0x01},
		{0x6640e, 0xe0},//nWin_Top = 276
		{0x66411, 0x05},
		{0x66412, 0x00},//nWin_Width = 736
		{0x66415, 0x03},
		{0x66416, 0xc0},//nWin_Height = 552
		...
		{0x6640a, 0x80},//nWin_Left //640
		{0x6640d, 0x01},
		{0x6640e, 0xc4},//nWin_Top // 452
		{0x66411, 0x07},
		{0x66412, 0x80},//nWin_Width // 1920
		{0x66415, 0x04},
		{0x66416, 0x38},//nWin_Height // 1080
...
static struct isp_regb_vals isp_aecgc_win_5M_center[] = {
#if 0
		{0x66409, 0x02},//definiton ofthe center 3x3 window
		{0x6640a, 0x80},//nWin_Left = 368
		{0x6640d, 0x01},
...
static struct isp_regb_vals isp_aecgc_win_5M_central_weight[] = {
#if 0
	{0x66409, 0x02},//definiton ofthe center 3x3 window
	{0x6640a, 0x80},//nWin_Left = 368
	{0x6640d, 0x01},
...
static struct v4l2_isp_parm ov4689_isp_parm = {
	.min_exposure = 0x02,
...
static const struct v4l2_isp_regval ov4689_isp_setting[] = {
	// wingtech OV4689 isp performance setting
	// module No.5
	...
	{0x1c15d, 0x02},
	{0x1c13e, 0x04},//real gain mode ov4689 gain mode

	{0x1c4dc, 0x01}, //new dyn framerate
	{0x1c4dd, 0x41},//vts increast to 0x41/0x20 @4x
	{0x1c4de, 0x61},//vts increast to 0x61/0x20 @8x
	{0x1c4df, 0x81},//vts increast to 0x81/0x20 @15x
	{0x1c4e0, 0x00},
	{0x1c4e1, 0x40},//4x
	{0x1c4e2, 0x00},
	{0x1c4e3, 0x80},//8x
...
/* Global Gamma */
	...
	/* BLC */
	{0x1c58b, 0x18},//avoid false contour Richard@0323
	{0x1c58c, 0x18},//avoid false contour Richard@0323
...
// *****************LENC **************************//
	...
	{0x1cccf, 0x80},//B gain for A
	{0x1ccd0, 0x80},//R gain for A
	{0x1c5b8, 0x8a},//B gain for C outdoor
	{0x1c5b9, 0x8a},//R gain for C outdoor
	{0x1ccd1, 0x8a},//B gain for C indoor
	{0x1ccd2, 0x8a},//R gain for C indoor
...
/* awb */
	...
	{0x1d807, 0x03},//a outdoor
	{0x1d808, 0x04},//cwf outdoor
	{0x1d809, 0x05},//day indoor
