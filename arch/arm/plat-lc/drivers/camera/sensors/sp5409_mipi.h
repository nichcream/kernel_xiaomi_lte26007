...
static struct v4l2_isp_parm SP5409_isp_parm = {
	.min_exposure = 0x01,
	.default_snapshot_exposure_ratio = 0x00b0,
	.default_preview_exposure_ratio = 0x0173,
	.sensor_vendor = SENSOR_VENDOR_SUPERPIX,
	.sensor_main_type = SP_5409,
	.sensor_sub_type = 1,
//	.byte_switch = 0x2,
	.mirror = 1,
	.flip = 0,
...
#endif
#endif
static const struct v4l2_isp_regval SP5409_isp_setting[] = {
#if 0
	// add for hdr
	{0x1c470, 0x01},
	{0x1c471, 0x00},
	...
	// for zte/leadcore SP5409 project
