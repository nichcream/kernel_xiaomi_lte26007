...
static struct clk_table clk_com_clkout_table[] = {
	...
	{4096000,  260000000, 0, 1280, 40625},
...
static struct clk_table clk_lcdc_table[] = {
	{156000000, 312000000, 8, 1, 2},
	{136500000, 312000000, 7, 1, 2},
	{117000000, 312000000, 6, 1, 2},
	{104000000, 312000000, 8, 1, 3},
	{97500000, 312000000, 5, 1, 2},
	{91000000, 312000000, 7, 1, 3},
	{78000000, 312000000, 8, 1, 4},
	{68000000, 312000000, 7, 1, 4},
	{65000000, 312000000, 5, 1, 3},
	{62000000, 312000000, 8, 1, 5},
	{58000000, 312000000, 6, 1, 4},
	{54000000, 312000000, 7, 1, 5},
	{52000000, 312000000, 8, 1, 6},
	{48000000, 312000000, 5, 1, 4},
	{46000000, 312000000, 6, 1, 5},
	{45000000, 312000000, 7, 1, 6},
	{44000000, 312000000, 8, 1, 7},
	{39000000, 312000000, 6, 1, 6},
	{34000000, 312000000, 7, 1, 8},
	{33000000, 312000000, 6, 1, 7},
	{32500000, 312000000, 5, 1, 6},
	{31200000, 312000000, 4, 1, 5},
	{29000000, 312000000, 3, 1, 4},
	{27000000, 312000000, 5, 1, 7},
	{26000000, 312000000, 2, 1, 3},
	{24000000, 312000000, 5, 1, 8},
	{23000000, 312000000, 3, 1, 5},
	{22000000, 312000000, 4, 1, 7},
	{19000000, 312000000, 2, 1, 4},
	{16000000, 312000000, 3, 1, 7},
	{15000000, 312000000, 4, 1, 5},
	{14000000, 312000000, 3, 1, 8},
	{13000000, 312000000, 1, 1, 3},
	{11000000, 312000000, 2, 1, 7},
	{9000000, 312000000, 1, 1, 4},
	{7000000, 312000000, 1, 1, 5},
	{6000000, 312000000, 1, 1, 6},
	{5000000, 312000000, 1, 1, 7},
	{4000000, 312000000, 1, 1, 8},
	{0, 0, 0, 0, 0},
};
...
static void comip_clk_a7_init(struct clk *clk);
static int comip_clk_a7_set_rate(struct clk *clk, unsigned long rate);
static void comip_clk_a7_pclkdbg_a7_atclk_init(struct clk *clk);
static int comip_clk_a7_pclkdbg_a7_atclk_set_rate(struct clk *clk, unsigned long rate);
...
static struct clk ddr_pwr_pll_mclk = {
	...
	.parent = &osc_clk,
	.flag = CLK_RATE_FIXED | CLK_ALWAYS_ENABLED,
	.divclk_reg = (void __iomem *)io_p2v(DDR_PWR_PLLCTL), /* for lc1813 */
	.grclk_reg = (void __iomem *)io_p2v(DDR_PWR_PLLCTL0), /* for lc1813s */
...
static struct clk com_clkout1_clk = {
	...
	.parent = &fraction_in_clk,
	.cust = &clk_com_clkout_table,
	.mclk_reg = (void __iomem *)io_p2v(DDR_PWR_CKO4L1CTL),
	.mclk_bit = 2,
	.mclk_we_bit = 18,
	.divclk_reg = (void __iomem *)io_p2v(DDR_PWR_CKO4L2CTL),
	.init = &comip_clk_init_by_table,
	.enable = &comip_clk_enable_generic,
	.disable = &comip_clk_disable_generic,
	.set_rate = &comip_clk_set_rate_by_table,
...
static struct clk pll0_out = {
	...
	.parent = &osc_clk,
	.flag = CLK_RATE_FIXED | CLK_ALWAYS_ENABLED,
	.divclk_reg = (void __iomem *)io_p2v(AP_PWR_PLL0CFG_CTL), /* for lc1813 */
	.grclk_reg = (void __iomem *)io_p2v(AP_PWR_PLL0CFG_CTL0), /* for lc1813s */
	.init = &comip_clk_pll_init,
};
...
static struct clk pll1_out = {
	...
	.parent = &osc_clk,
	.flag = CLK_RATE_FIXED | CLK_ALWAYS_ENABLED,
	.divclk_reg = (void __iomem *)io_p2v(AP_PWR_PLL1CFG_CTL), /* for lc1813 */
	.grclk_reg = (void __iomem *)io_p2v(AP_PWR_PLL1CFG_CTL0), /* for lc1813s */
	.init = &comip_clk_pll_init,
};
...
/* Application Unit. */
static struct clk a7_clk = {
	.name = "a7_clk",
	.parent = &pll0_out,
	.divclk_reg = (void __iomem *)io_p2v(AP_PWR_RESERVED_REG),
	.divclk_bit = 0,
	.grclk_reg = (void __iomem *)io_p2v(AP_PWR_A7_CLK_CTL),
	.grclk_bit = 0,
	.grclk_mask = 0x1f,
	.grclk_we_bit = 16,
	.init = &comip_clk_a7_init,
	.enable = &comip_clk_enable_generic,
	.disable = &comip_clk_disable_generic,
	.set_rate = &comip_clk_a7_set_rate,
};

static struct clk a7_pclkdbg_clk = {
	.name = "a7_pclkdbg_clk",
	.parent = &a7_clk,
	.grclk_reg = (void __iomem *)io_p2v(AP_PWR_A7_CLK_CTL),
	.grclk_bit = 8,
	.grclk_mask = 0xf,
	.grclk_we_bit = 17,
	.init = &comip_clk_a7_pclkdbg_a7_atclk_init,
	.enable = &comip_clk_enable_generic,
	.disable = &comip_clk_disable_generic,
	.set_rate = &comip_clk_a7_pclkdbg_a7_atclk_set_rate,
};

static struct clk a7_atclk_clk = {
	.name = "a7_atclk_clk",
	.parent = &a7_clk,
	.grclk_reg = (void __iomem *)io_p2v(AP_PWR_A7_CLK_CTL),
	.grclk_bit = 12,
...
static struct clk a7_adb_aclks_clk = {
	.name = "a7_adb_aclks_clk",
	.parent = &a7_clk,
};
...
static struct clk a7_tsp_clk = {
	...
	.parent = &a7_clk,
	.fix_div = 8,
	.flag = CLK_RATE_DIV_FIXED | CLK_INIT_ENABLED,
	.mclk_reg = (void __iomem *)io_p2v(AP_PWR_A7TSP_CTL),
	.mclk_bit = 0,
	.mclk_we_bit = 16,
	.enable = &comip_clk_enable_generic,
	.disable = &comip_clk_disable_generic,
...
static struct clk a7_axi_clk = {
	.name = "a7_axi_clk",
	.parent = &pll1_out,
	.flag = CLK_ALWAYS_ENABLED,
	.cust = &clk_range3_3_6,
	.divclk_reg = (void __iomem *)io_p2v(AP_PWR_A7AXI_MAINCLK_CTL),
	.divclk_bit = 4,
	.divclk_mask = 0x3,
	.divclk_we_bit = 17,
	.grclk_bit = 0,
...
static struct clk _2dacc_mclk = {
	.name = "2dacc_mclk",
	.parent = &pll1_out,
	.cust = &clk_range3_3_6,
	.divclk_reg = (void __iomem *)io_p2v(AP_PWR_2DACCMCLK_CTL),
	.divclk_bit = 4,
	.divclk_mask = 0x3,
	.divclk_we_bit = 17,
	.grclk_bit = 0,
...
static struct clk dbg_pclk = {
	...
	.mclk_reg = (void __iomem *)io_p2v(AP_PWR_A7DBGPCLK_CTL),
	.mclk_bit = 0,
	.mclk_we_bit = 16,
	.divclk_reg = (void __iomem *)io_p2v(AP_PWR_A7DBGPCLK_CTL),
	.divclk_bit = 4,
	.divclk_mask = 0xf,
	.divclk_we_bit = 17,
	.init = &comip_clk_init_generic,
