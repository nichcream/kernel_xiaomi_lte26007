...
/* SETTINGS */
#define CUT_UNIT         (1)		//Andy 2012.6.6: it was (1000) previously. But I don't think the customer need als data with such accuracy.
...
#define PSGAIN_X1        		(0x0 << 4)  //grace modify in 2014.4.11
#define PSGAIN_X2        		(0x1 << 4)  //grace modify in 2014.4.11
#define PSGAIN_X4        		(0x2 << 4)  //grace modify in 2014.4.11
#define INFRARED_LOW        (0x0)       //grace modify in 2014.5.6
#define INFRARED_MID        (0x1 )  		//grace modify in 2014.5.6
#define INFRARED_HIGH       (0x3 )  		//grace modify in 2014.5.6
...
#define PS_DOUBLE_PULSE       (1 << 5)  //grace modify in 2014.5.6
#define PS_ALS_SET_ALSPS_CONTROL  (LEDCURRENT_100MA | ALSGAIN_X1X1)	//Set high gain value to acquire high accuracy
#define PS_ALS_SET_INTR_PERSIST   (PSGAIN_X1| 0x1)//(1)//grace modify in 2014.4.11
#define PS_ALS_SET_INTR           (PS_THH_BOTH_OUTSIDE| POLA_ACTIVEL | OUTPUT_LATCH | MODE_PROXIMITY)
#define PS_ALS_SET_PS_TH          (80)	//Customer should change the threshold value according to their mechanical design and measured data
