...
/* 4. 用于IC固件版本2.0版本以下的旧版固件芯片（旧BF685X坐标寄存器仅3字节） */
...
/* 7. 手势支持根据具体手势打开下面相应映射按键 gesture function  */
	...
	#ifdef BYD_GESTURE
	 #define BYD_TS_GESTURE_KEYS { KEY_U,\
		KEY_D,\
		KEY_L,\
		KEY_R,\
		KEY_W,\
...
/* 8. 按键定义（如KEY_BACK, KEY_MENU, KEY_HOME, KEY_SEARCH, KEY_SEND, ...等，请
	  ...
	  #define KEY_HOME  172
	  #define BYD_TS_KEYS { KEY_MENU, KEY_HOME, KEY_BACK, KEY_SEARCH }

	  //#define BYD_TS_KEYS { KEY_MENU, KEY_SEARCH, KEY_HOME, KEY_BACK }

/* 9. 版本信息，如下格式：
      IC编码-IC封装码-IC固件版本号-驱动版本号-客户编码-项目编码-参数版本编码 */
	  #define BYD_TS_DRIVER_DESCRIPTION "BYD Touchscreen Driver, Version: " \
	      "CTS01-BF686X-COF2.0-DRV2.10-CLIENT0000-PROJ00-PARA1.0"
...
* 头文件的引用顺序.将 I2C设备挂载到平台的 I2C总线，需要告知平台设备名BYD_TS_NAME，I2C从地址
...
/* 1. 配置中断 */
   ...
   /* 中断端口号，可选
      ...
      raw data显示，否则请省略 */
	  #define GPIO_TS_EINT  MFP_PIN_GPIO(162)//BF686x_INT_PIN //MFP_PIN_GPIO(162) //MFP_PIN_GPIO(166) //S5PV210_GPH0(1) //S5PV210_GPH1(7) // GPIO_TS_WAKE port is used instead // S5PV210_GPH0(5)
