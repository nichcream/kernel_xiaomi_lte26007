...
{
	int err;
    printk("=======liuyang2  cfg80211_init enter!\n");
...
#endif
    printk("=======liuyang2  cfg80211_init 1!\n");

	err = wiphy_sysfs_init();
	if (err)
		goto out_fail_sysfs;
    printk("=======liuyang2  cfg80211_init 2!\n");

	err = register_netdevice_notifier(&cfg80211_netdev_notifier);
	if (err)
		goto out_fail_notifier;
    printk("=======liuyang2  cfg80211_init 3!\n");

	err = nl80211_init();
	if (err)
		goto out_fail_nl80211;
    printk("=======liuyang2  cfg80211_init 4!\n");
	...
	if (err)
		goto out_fail_reg;
    printk("=======liuyang2  cfg80211_init 5!\n");
...
subsys_initcall_sync(cfg80211_init);
