...
int cw1200_data_read(struct CW1200_priv *priv,
		     void *buf, size_t buf_len);
int cw1200_data_write(struct CW1200_priv *priv,
		      const void *buf, size_t buf_len);

int cw1200_reg_read(struct CW1200_priv *priv, u16 addr,
		    void *buf, size_t buf_len);
int cw1200_reg_write(struct CW1200_priv *priv, u16 addr,
		     const void *buf, size_t buf_len);
...
static inline int cw1200_reg_read_16(struct CW1200_priv *priv,
				     u16 addr, u16 *val)
{
	u32 bigVal;
	int ret;
...
static inline int cw1200_reg_write_16(struct CW1200_priv *priv,
				      u16 addr, u16 val)
{
	u32 bigVal = (u32)val;
...
static inline int cw1200_reg_read_32(struct CW1200_priv *priv,
				     u16 addr, u32 *val)
{
	return cw1200_reg_read(priv, addr, val, sizeof(val));
}

static inline int cw1200_reg_write_32(struct CW1200_priv *priv,
				      u16 addr, u32 val)
{
	return cw1200_reg_write(priv, addr, &val, sizeof(val));
}

static inline int cw1200_apb_read(struct CW1200_priv *priv, u32 addr,
				  void *buf, size_t buf_len)
{
...
static inline int cw1200_ahb_read(struct CW1200_priv *priv, u32 addr,
				  void *buf, size_t buf_len)
{
	return cw1200_indirect_read(priv, addr, buf, buf_len,
...
static inline int cw1200_apb_read_32(struct CW1200_priv *priv,
				     u32 addr, u32 *val)
{
	return cw1200_apb_read(priv, addr, val, sizeof(val));
}

static inline int cw1200_ahb_read_32(struct CW1200_priv *priv,
				     u32 addr, u32 *val)
{
