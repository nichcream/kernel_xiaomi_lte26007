...
static struct pmic_reg_st lc1160_init_regs[] = {
	...
	/*DCDC9 enable when sleep */
       {LC1160_REG_DC9OVS1, 0x01, LC1160_REG_BITMASK_DC9OVS1_DC9SLP},
	{LC1160_REG_DC9OVS1, 0x01, LC1160_REG_BITMASK_DC9OVS1_DC9EN},
      {LC1160_REG_DC9OVS1, 0x39, LC1160_REG_BITMASK_DC9OVS1_DC9VOUT1},
...
#if defined(CONFIG_CHARGER_BQ2419X)
	{
		I2C_BOARD_INFO("bq2419x_charger", 0x6B),
...
#if defined(CONFIG_LCD_IVO_OTM1283A)
