...
#if defined(CONFIG_RTL8672) || defined(WIFI_WPAS_CLI)
...
#if defined(WIFI_HAPD) || defined(RTK_NL80211) || defined (WIFI_WPAS_CLI)
	u_int8_t wpa_ie[256];
...
#endif
#ifdef REVO_MIFI
struct task_struct *wps_wake_thread;
struct completion wps_wake_thread_done;
#endif
#ifdef CONFIG_POWER_SUSPEND
struct wake_lock rtw_suspend_lock;
...
//	unsigned short			F90_cnt;
...
#if (defined(CONFIG_RTL_88E_SUPPORT) && defined(TXREPORT)) || defined(SDIO_AP_PS)
	...
	bool				PLL_reset_ok;
#endif
	unsigned char hw_seq_ctrl_backup; 
};
...
#define BCN_BUF  5632//5120     //wlan0+4 VAP ,a port need 1KB,512B for Beacon,512B for Probe RSP
#else
#define BCN_BUF  2048
#endif
...
typedef struct rtl8192cd_priv {
	...
	*/
	...
	struct tx_desc                  tx_descP;
	struct tx_desc                  tx_descB1;
	struct tx_desc                  tx_descP1;
#endif
#ifdef WIFI_SIMPLE_CONFIG
	//unsigned int			beaconbuf[MAX_WSC_IE_LEN];
	unsigned int                  beaconbuf[BCN_BUF];
