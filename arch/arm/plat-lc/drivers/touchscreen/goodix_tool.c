...
#endif
#ifdef CONFIG_TOUCHSCREEN_GT813
#include <plat/gt813_827_828.h>
#endif
...
Output:
	Return write length.
********************************************************/
static s32 goodix_tool_write(struct file *file, const char __user *buff,
...
Output:
	Return read length.
********************************************************/
static s32 goodix_tool_read(struct file *file, char __user *buffer,
                        					size_t count, loff_t *ppos)
...
static const struct file_operations goodix_tool_operations = {
        .owner = THIS_MODULE,
...
s32 init_wr_node(struct i2c_client *client)
{
    ...
    goodix_proc_entry = proc_create_data(GOODIX_ENTRY_NAME, 0666, NULL,
    						&goodix_tool_operations, client);
