#ifndef __ASM_ARCH_BOARD_YONGDA_H__
#define __ASM_ARCH_BOARD_YONGDA_H__

#include <plat/mfp.h>
#include <plat/comipfb.h>

#if defined(CONFIG_COMIP_PROJECT_YONGDA)
...
/* LCD. */
#define LCD_RESET_PIN			MFP_PIN_GPIO(125)
...
#define BRCM_BT_ONOFF_PIN       MFP_PIN_GPIO(198)
...
#define ICN6201_IRQ_PIN				MFP_PIN_GPIO(162)
#define ICN6201_EN				MFP_PIN_GPIO(108)
#endif
