...
typedef struct _RT_LINK_DETECT_T{
	u64				LastRxBytesInPeriod;
	u64				MaxRxBytesInPeriod;
	u32				NumTxOkInPeriod;
	u32				NumRxOkInPeriod;
...
struct mlme_priv {
	...
	/* used for need_indicate_scan_done */
	/* for indicate scanlist but */
	/* not realy scan */
	u8	fake_scantime;
	u32	scan_compensation;
...
#ifdef CONFIG_CONCURRENT_MODE
#ifdef CONFIG_P2P
	u8	linked_p2p_lock_flag;
#endif
#endif
#endif //CONFIG_LINKED_LCOK
	u8	android_btcex_bdhcp;
};
