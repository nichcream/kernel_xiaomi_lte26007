...
static struct v4l2_isp_parm ov9760_isp_parm = {
	.min_exposure = 0x01,
...
static const struct v4l2_isp_regval ov9760_isp_setting[] = {
...
//	{0x1c537, 0x0f},
	...
	{0x1c146, 0x40},//2c}//40(Richard) ori0x30 low AE target
	{0x1c14a, 0x04},//Stable range[0]
	{0x1c14b, 0x08},//Stable range[1]
	{0x1c14c, 0x0a},//aec fast step//
	{0x1c14e, 0x08},// 8  slow step
	{0x1c140, 0x01},//banding
	{0x1c13f, 0x02},
...
//	{0x1c177, 0xd8},
	...
	{0x6640d, 0x00},
	{0x6640e, 0x70},//nWin_Top = 150
	{0x66411, 0x03},
	{0x66412, 0x70},//nWin_Width = 880
	{0x66415, 0x01},
	{0x66416, 0xf0},//nWin_Height = 660
	{0x6642e, 0x01},//nWin_Weight_0 weight pass
	{0x6642f, 0x01},//nWin_Weight_1
	{0x66430, 0x01},//nWin_Weight_2
	{0x66431, 0x01},//nWin_Weight_3
...
/* sharpeness */
	...
	{0x65608, 0x06},
	{0x65609, 0x20},
	{0x6560c, 0x06}, //06}//min_sharpen
	{0x6560d, 0x18}, //18}// max_sharpen
...
/* AWB */
	...
	{0x1cccf, 0x08},//ori = 08, B gain for A
