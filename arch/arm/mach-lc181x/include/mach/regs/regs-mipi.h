...
#define MIPI_DPI_CFG					(0x0C)
#define MIPI_PCKHDL_CFG 				(0x18)
#define MIPI_VID_MODE_CFG				(0x1C)
#define MIPI_VID_PKT_CFG				(0x20)
#define MIPI_CMD_MODE_CFG				(0x24)
#define MIPI_TMR_LINE_CFG				(0x28)
#define MIPI_VTIMING_CFG				(0x2C)
#define MIPI_PHY_TMR_CFG				(0x30)
#define MIPI_GEN_HDR					(0x34)
#define MIPI_GEN_PLD_DATA				(0x38)
#define MIPI_CMD_PKD_STATUS 				(0x3C)
#define MIPI_TO_CNT_CFG 				(0x40)
#define MIPI_ERROR_ST0					(0x44)
#define MIPI_ERROR_ST1					(0x48)
#define MIPI_ERROR_MSK0 				(0x4C)
#define MIPI_ERROR_MSK1 				(0x50)
#define MIPI_PHY_RSTZ					(0x54)
#define MIPI_PHY_IF_CFG 				(0x58)
#define MIPI_PHY_IF_CTRL				(0x5C)
#define MIPI_PHY_STATUS 				(0x60)
#define MIPI_PHY_TEST_CTRL0				(0x64)
#define MIPI_PHY_TEST_CTRL1				(0x68)
...
/* MIPI_DPI_CFG. */
#define MIPI_EN18_LOOSELY				10		
#define MIPI_COLORM_ACTIVE_LOW	  			9
#define MIPI_SHUTD_ACTIVE_LOW				8
#define MIPI_HSYNC_ACTIVE_LOW				7
#define MIPI_VSYNC_ACTIVE_LOW		  		6
#define MIPI_DATAEN_ACTIVE_LOW	  			5
#define MIPI_DPI_COLOR_CODING				2
#define MIPI_DPI_VID					0

/* MIPI_PCKHDL_CFG. */
#define MIPI_GET_VID_RX			  		5
#define MIPI_EN_CRC_RX					4
#define MIPI_EN_ECC_RX					3
#define MIPI_EN_BTA 					2
#define MIPI_EN_EOTN_RX					1
#define MIPI_EN_EOTP_RX					0

/* MIPI_VID_MODE_CFG. */
#define MIPI_FRAME_BTA_ACK			  	11
#define MIPI_EN_NULL_PKT				10
#define MIPI_EN_MULTI_PKT			  	9
#define MIPI_EN_LP_HFP					8
#define MIPI_EN_LP_HBP					7
#define MIPI_EN_LP_VACT 				6
#define MIPI_EN_LP_VFP					5
#define MIPI_EN_LP_VBP					4
#define MIPI_EN_LP_VSA					3
#define MIPI_VID_MODE_TYPE				1
#define MIPI_EN_VIDEO_MODE				0

/* MIPI_VID_PKT_CFG. */
#define MIPI_NULL_PKT_SIZE			  	21
#define MIPI_NUM_CHUNKS 			  	11
#define MIPI_VID_PKT_SIZE				0

/* MIPI_CMD_MODE_CFG. */
#define MIPI_EN_TEAR_FX			  		14
#define MIPI_EN_ACK_RQST			  	13
#define MIPI_DCS_LW_TX			  		12
#define MIPI_GEN_LW_TX					11
#define MIPI_MAX_RD_PKT_SIZE	  			10
#define MIPI_DCS_SW_2P_TX		  		9
#define MIPI_DCS_SW_LP_TX				8
#define MIPI_DCS_SW_0P_TX				7
#define MIPI_GEN_SR_2P_TX		  		6
#define MIPI_GEN_SR_LP_TX				5
#define MIPI_GEN_SR_0P_TX				4	
#define MIPI_GEN_SW_2P_TX		  		3
#define MIPI_GEN_SW_LP_TX				2
#define MIPI_GEN_SW_0P_TX				1	 
#define MIPI_EN_CMD_MODE			  	0

/* MIPI_TMR_LINE_CFG. */
#define MIPI_HLINE_TIME			  		18
#define MIPI_HBP_TIME					9	 
#define MIPI_HAS_TIME					0

/* MIPI_VTIMING_CFG. */
#define MIPI_V_ACTIVE_LINES			  	16 
#define MIPI_VFP_LINES				  	10 
#define MIPI_VBP_LINES				  	4 
#define MIPI_VSA_LINES				  	0 

/* MIPI_PHY_TMR_CFG. */
#define MIPI_PHY_HS2LP_TIME			  	20
#define MIPI_PHY_LP2HS_TIME			  	12
#define MIPI_BTA_TIME					0

/* MIPI_GEN_HDR. */
#define MIPI_GEN_HDATA			  		8
#define MIPI_GEN_HTYPE			  		0
...
/* MIPI_TO_CNT_CFG. */
#define MIPI_LPRX_TO_CNT			  	16
#define MIPI_HSTX_TO_CNT			  	0
...
/* MIPI_PHY_IF_CFG. */
#define MIPI_PHY_STOP_WAIT_TIME			  	2
#define MIPI_PHY_N_LANES			  	0

/* MIPI_PHY_IF_CTRL. */
#define MIPI_PHY_TX_TRIGGERS				5
#define MIPI_PHY_TXEXITULPSLAN				4
#define MIPI_PHY_TXREQULPSLAN				3
#define MIPI_PHY_TXEXITULPSCLK				2
#define MIPI_PHY_TXREQULPSCLK				1
...
#define MIPI_CTRL0_PHY_TTESTCLR				0
