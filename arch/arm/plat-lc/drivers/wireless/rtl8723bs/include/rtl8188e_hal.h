...
#include "../hal/OUTSRC/odm_precomp.h"
	...
	#define Rtl8188E_FwImageArray_SMIC		Array_MP_8188E_FW_SMIC
	#define Rtl8188E_FWImgArrayLength_SMIC	ArrayLength_MP_8188E_FW_SMIC
#ifdef CONFIG_WOWLAN
	#define Rtl8188E_FwWoWImageArray			Array_8188E_FW_WoWLAN
	#define Rtl8188E_FwWoWImgArrayLength		ArrayLength_8188E_FW_WoWLAN
	#define Rtl8188E_FwWoWImageArray_SMIC			Array_MP_8188E_FW_WoWLAN_SMIC
	#define Rtl8188E_FwWoWImgArrayLength_SMIC		ArrayLength_MP_8188E_FW_WoWLAN_SMIC
#endif //CONFIG_WOWLAN
...
#define FW_8188E_SIZE				0x6000 //16384,16k==>24576,24K because the size of FW for SMIC is larger than 16K
...
#define MAX_RX_DMA_BUFFER_SIZE_88E	      0x1E00   //7680, for huawei k3v2, RX
#else
#define MAX_RX_DMA_BUFFER_SIZE_88E	      0x2400 //9k for 88E nornal chip , //MaxRxBuff=10k-max(TxReportSize(64*8), WOLPattern(16*24))
#define MAX_RX_DMA_BUFFER_SIZE_88E_SMIC	0x3C00 //15KB for SMIC chip
...
#ifdef CONFIG_WOWLAN
#define TX_TOTAL_PAGE_NUMBER_88E		0xA6
#define TX_TOTAL_PAGE_NUMBER_88E_SMIC		0xF3
#else
#define TX_TOTAL_PAGE_NUMBER_88E		0xA9//  169 (21632=> 21k)
#define TX_TOTAL_PAGE_NUMBER_88E_SMIC	0xF8
#endif
...
#define TX_PAGE_BOUNDARY_88E_SMIC (TX_TOTAL_PAGE_NUMBER_88E_SMIC + 1)
#endif
...
#define WMM_NORMAL_TX_TOTAL_PAGE_NUMBER_SMIC	TX_TOTAL_PAGE_NUMBER_88E_SMIC  //0xF8 ,
#define WMM_NORMAL_TX_PAGE_BOUNDARY_88E_SMIC	(WMM_NORMAL_TX_TOTAL_PAGE_NUMBER_SMIC + 1) //0xF8
