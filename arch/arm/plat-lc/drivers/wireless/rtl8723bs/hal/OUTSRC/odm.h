...
#define ASSOCIATE_ENTRY_NUM					NUM_STA		 // Max size of AsocEntry[].
...
#define ODM_IC_11N_SERIES		(ODM_RTL8192S|ODM_RTL8192C|ODM_RTL8192D|ODM_RTL8723A|ODM_RTL8188E|ODM_RTL8723B)
...
typedef struct ODM_RF_Calibration_Structure
{
	...
	u1Byte 	CCK_index;
	u1Byte 	OFDM_index[2];
	s1Byte	PowerIndexOffset[ODM_RF_PATH_MAX];
	s1Byte	DeltaPowerIndex[ODM_RF_PATH_MAX];
	s1Byte	DeltaPowerIndexLast[ODM_RF_PATH_MAX];
...
//------------CALL BY VALUE-------------//
	...
	// TX power tracking
	//
	u1Byte			BbSwingIdxOfdm[ODM_RF_PATH_MAX];
	u1Byte			BbSwingIdxOfdmCurrent;
	u1Byte			BbSwingIdxOfdmBase[ODM_RF_PATH_MAX];
