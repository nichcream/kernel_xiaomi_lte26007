...
void BT_ScanNotify(PADAPTER padapter, u8 scanType);
...
void BT_SpecialPacketNotify(PADAPTER padapter, u1Byte pktType);
...
#define BT_IsDisableEdcaTurbo BTDM_DisableEDCATurbo
...
void BT_IpsNotify(PADAPTER padapter, u1Byte type);
void BT_LpsNotify(PADAPTER Adapter, u1Byte type);
void BT_SetManualControl(PADAPTER Adapter, BOOLEAN Flag);
...
u8 BT_IsLowPwrDisable(PADAPTER padapter);
...
//compat 8723BS
#define	BT_IsBtControlLps(Adapter)						FALSE
...
#define BT_WiFiConnectNotify(padapter, status)
