...
#define AP_PWR_A7Cx_PD_CTL(X)	(AP_PWR_A7C1_PD_CTL + ((X)-1)*4)

#define GIC_DIST_BASE	((CPU_CORE_BASE) + 0x1000)
#define GIC_CPU_BASE	((CPU_CORE_BASE) + 0x2000)

#define CPU0_WAKEUP_CMD_ADDR	(CTL_AP_HA7_CORE1_CBOOT_ADDR)
/*bit wide: 8 bits*/
#define CPU0_SLP_STATE_ADDR	(CTL_AP_HA7_CORE2_CBOOT_ADDR)
#define CPU1_SLP_STATE_ADDR	(CTL_AP_HA7_CORE3_CBOOT_ADDR)
#define CPU2_SLP_STATE_ADDR	(TOP_MAIL_GEN_REG0)
#define CPU3_SLP_STATE_ADDR	(TOP_MAIL_GEN_REG1)
#define CPU4_SLP_STATE_ADDR	(CPU0_SLP_STATE_ADDR)

#define CPU0_WBOOT_ADDR	(CTL_AP_HA7_CORE0_WBOOT_ADDR)
#define CPU1_CBOOT_ADDR	(CTL_AP_HA7_CORE1_CBOOT_ADDR)
#define CPU1_WBOOT_ADDR	(CTL_AP_HA7_CORE1_WBOOT_ADDR)

#define CPU2_CBOOT_ADDR	(CTL_AP_HA7_CORE2_CBOOT_ADDR)
#define CPU2_WBOOT_ADDR	(CTL_AP_HA7_CORE2_WBOOT_ADDR)
#define CPU3_CBOOT_ADDR	(CTL_AP_HA7_CORE3_CBOOT_ADDR)
#define CPU3_WBOOT_ADDR	(CTL_AP_HA7_CORE3_WBOOT_ADDR)
