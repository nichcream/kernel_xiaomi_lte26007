...
#ifdef CONFIG_P2P
#define RTW_SUSPEND_P2P_LOCK_NAME "rtw_p2p"
#endif
#endif
...
#ifdef CONFIG_CONCURRENT_MODE
#ifdef CONFIG_P2P
static struct wake_lock rtw_suspend_p2p_lock;
#endif
#endif
...
#ifdef CONFIG_CONCURRENT_MODE
#ifdef CONFIG_P2P
static android_suspend_lock_t rtw_suspend_p2p_lock ={
	.name = RTW_SUSPEND_P2P_LOCK_NAME
};
#endif
#endif
#endif
...
inline void rtw_suspend_lock_init()
{
	...
	#ifdef CONFIG_CONCURRENT_MODE
	#ifdef CONFIG_P2P
	wake_lock_init(&rtw_suspend_p2p_lock, WAKE_LOCK_SUSPEND, RTW_SUSPEND_P2P_LOCK_NAME);
	#endif
	#endif
	#elif defined(CONFIG_ANDROID_POWER)
	_rtw_spinlock_init(&rtw_wakelock_spinlock);
	...
	#ifdef CONFIG_CONCURRENT_MODE
	#ifdef CONFIG_P2P
	android_init_suspend_ext_lock(&rtw_suspend_p2p_lock);
	#endif
	#endif
	#endif
...
inline void rtw_suspend_lock_uninit()
{
...
#ifdef CONFIG_P2P
#ifdef CONFIG_PLATFORM_LEADCORE
	if(rtw_suspend_p2p_lock.ws.entry.next == LIST_POISON1 || rtw_suspend_p2p_lock.ws.entry.prev == LIST_POISON2) {
#else
	if(rtw_suspend_p2p_lock.link.next == LIST_POISON1 || rtw_suspend_p2p_lock.link.prev == LIST_POISON2) {
#endif
		DBG_871X("%s rtw_suspend_p2p_lock list poison!!\n", __FUNCTION__);
		return;
	}
#endif
#endif
	...
	#ifdef CONFIG_CONCURRENT_MODE
	#ifdef CONFIG_P2P
	wake_lock_destroy(&rtw_suspend_p2p_lock);
	#endif
	#endif
	...
	#ifdef CONFIG_CONCURRENT_MODE
	#ifdef CONFIG_P2P
	android_uninit_suspend_lock(&rtw_suspend_p2p_lock);
	#endif
	#endif
	_rtw_spinlock_free(&rtw_wakelock_spinlock);
	#endif
...
inline static void _rtw_lock_suspend(void)
{
	...
	#if  defined(CONFIG_WAKELOCK) || defined(CONFIG_ANDROID_POWER)
#ifndef CONFIG_PLATFORM_LEADCORE
...
#ifdef CONFIG_CONCURRENT_MODE
#ifdef CONFIG_P2P
inline void rtw_lock_suspend_p2p()
{
	#if  defined(CONFIG_WAKELOCK) || defined(CONFIG_ANDROID_POWER)
#ifdef CONFIG_PLATFORM_LEADCORE
	if(rtw_suspend_p2p_lock.ws.entry.next == LIST_POISON1 || rtw_suspend_p2p_lock.ws.entry.prev == LIST_POISON2) {
	...
	DBG_871X(" %s\n",__FUNCTION__);
	#ifdef CONFIG_WAKELOCK
	wake_lock(&rtw_suspend_p2p_lock);
	#elif defined(CONFIG_ANDROID_POWER)
	android_lock_suspend(&rtw_suspend_p2p_lock);
	#endif

}

inline void rtw_unlock_suspend_p2p()
{
	#if  defined(CONFIG_WAKELOCK) || defined(CONFIG_ANDROID_POWER)
#ifdef CONFIG_PLATFORM_LEADCORE
	if(rtw_suspend_p2p_lock.ws.entry.next == LIST_POISON1 || rtw_suspend_p2p_lock.ws.entry.prev == LIST_POISON2) {
	...
	DBG_871X("%s\n",__FUNCTION__);
	#ifdef CONFIG_WAKELOCK
	wake_unlock(&rtw_suspend_p2p_lock);
	#elif defined(CONFIG_ANDROID_POWER)
	android_unlock_suspend(&rtw_suspend_p2p_lock);
	#endif
}
#endif
#endif
