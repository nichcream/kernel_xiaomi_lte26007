...
void
ODM_ReadAndConfig_TC_8814A_MAC_REG(
 	IN   PDM_ODM_T  pDM_Odm
 	)
{
    u4Byte     i         = 0;
    u4Byte     ArrayLen    = sizeof(Array_TC_8814A_MAC_REG)/sizeof(u4Byte);
    pu4Byte    Array       = Array_TC_8814A_MAC_REG;
	
    ODM_RT_TRACE(pDM_Odm, ODM_COMP_INIT, ODM_DBG_LOUD, ("===> ODM_ReadAndConfig_TC_8814A_MAC_REG\n"));
...
u4Byte
ODM_GetVersion_TC_8814A_MAC_REG(void)
{
	   return 11;
}
